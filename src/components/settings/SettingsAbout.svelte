...
<div class="section-body">
  <div class="card settings-card">
    <div class="about-hero">
      <img src={iconUrl('/icons/logo.png')} alt="NoteTrace" class="about-icon" />
      <div>
    ...
    <div class="about-desc">
      Trace Every Thought. NoteTrace keeps your notes, lists, and reminders
      together in one place, quick to capture and easy to find. Your data
