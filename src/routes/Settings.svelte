<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    appearance:    ['appearance','theme','dark','light','accent','color','navigation','sidebar','persistent','start page','animations','collapse sidebar','icon sidebar','rail','link previews','link preview','previews','reduce motion','banner','page banner','force mobile','mobile layout','mobile view','phone layout','narrow layout'],
