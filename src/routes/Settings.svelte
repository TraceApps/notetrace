<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    appearance:    ['appearance','theme','dark','light','accent','color','navigation','sidebar','persistent','start page','animations','collapse sidebar','icon sidebar','rail','link previews','link preview','previews','note order','sort','custom order','drag','reorder','arrange','keyboard','shortcuts','hotkeys','keys','density','compact','comfortable','dense','card size','reduce motion','banner','page banner','force mobile','mobile layout','mobile view','phone layout','narrow layout'],
