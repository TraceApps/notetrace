<script>
  ...
  const SECTION_KEYWORDS = {
    ...
    notes:         ['notes','cards','density','compact','comfortable','dense','card size','note order','sort','custom order','drag','reorder','arrange','swipe','gesture','gestures','archive','keyboard','shortcuts','hotkeys','keys','link previews','link preview','previews','tasks','every checklist','checklists in tasks','shopping list','templates','template','new from template','date token'],
