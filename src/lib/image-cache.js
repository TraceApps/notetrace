 ...
 *
 * Scans server data (user avatar; note attachments once they land) for
 * image URLs, fetches each via CapacitorHttp, writes to
 ...
 *
 * Ported from NutriTrace src/lib/image-cache.js.
 */
...
// Bumped to 3 on the WebView hostname flip (localhost → app.notetrace.local).
